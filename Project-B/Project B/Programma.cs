...
namespace Project_B
{
    public partial class Programma : Form
    {
        ...
        public string MovieTitle(string movietitle)
        {
            ...
            else if(movietitle.Contains("The Dark Kinght Rises"))
            {
                return movie = "The Dark Kinght Rises";
            }
            ...
            else if (movietitle.Contains("The Lord of the rings fellowschip of the ring"))
            {
                return movie = "The Lord of the rings fellowschip of the ring";
            }
            ...
            else if (movietitle.Contains("Peter rabit 2"))
            {
                return movie = "Peter rabit 2";
            }
